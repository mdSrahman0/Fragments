...
public class BlueFragment extends Fragment implements View.OnClickListener {
    ...
    EditText etSSN;
    Button btnSendNudesToMainActivity;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        etSSN = view.findViewById(R.id.etUserInput);
        btnSendNudesToMainActivity = view.findViewById(R.id.btnSendNudes);
        btnSendNudesToMainActivity.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        ...
        mListener.sendNudesToActivity(ssn);
    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void sendNudesToActivity(String string);
    }
}
